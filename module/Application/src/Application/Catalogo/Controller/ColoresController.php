...
class ColoresController extends AbstractActionController
{
		...
		if($request->isPost()){
            ...
            */
            ...
            if(!empty($post_data['search']['value'])){
                ...
                $c1= $c->getNewCriterion('color.idcolor', '%'.$search_value.'%', \Criteria::LIKE);
                $c2= $c->getNewCriterion('color.color_nombre', '%'.$search_value.'%', \Criteria::LIKE);

          
                $c1->addOr($c2);

                $query->addAnd($c1);
                $query->groupByIdcolor();
            ...
            foreach ($query->find()->toArray(null,false,  \BasePeer::TYPE_FIELDNAME) as $value){
                ...
                $tmp['DT_RowId'] = $value['idcolor'];
                $tmp['idcolor'] = $value['idcolor'];
                ...
                $tmp['options'] = '<td><div class="btn-group dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="/catalogo/colores/ver/' . $value['idcolor'] . '">
                        <div class="media">
    ...
    public function indexAction()
    {
    	...
    	$view_model->setTemplate('application/catalogo/colores/index');
    ...
    public function nuevoAction()
    {
    	...
    	if($request->isPost())
    	{
    		...
    		foreach ($post_data as $key => $value) {
    			if(\ColorPeer::getTableMap()->hasColumn($key))
    			{
    		...
    		return $this->redirect()->toUrl('/catalogo/colores');
    	}


    	$form = new \Application\Catalogo\Form\ColoresForm();
    	$view_model = new ViewModel();
    	$view_model->setTemplate('application/catalogo/colores/nuevo');
    	$view_model->setVariables(array(
    		'form' => $form
    	));
    ...
    public function verAction()
    {
    	...
    	$exists = \ColorQuery::create()->filterByIdcolor($id)->exists();

    	if($exists)
    	{
    		$entity = \ColorQuery::create()->findPk($id);
    		...
    		$view_model = new ViewModel();
    		$view_model->setTemplate('application/catalogo/colores/ver');
