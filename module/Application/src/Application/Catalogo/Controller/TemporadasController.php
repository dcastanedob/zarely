...
class TemporadasController extends AbstractActionController
{
    ...
    public function serversideAction(){
        ...
        if ($request->isPost()) {
            ...
            if (!empty($post_data['search']['value'])) {
                ...
                $c1 = $c->getNewCriterion('temporada.idtemporada', '%' . $search_value . '%', \Criteria::LIKE);
                $c2 = $c->getNewCriterion('temporada.temporada_nombre', '%' . $search_value . '%', \Criteria::LIKE);
                $c1->addOr($c2);

                $query->addAnd($c1);
                $query->groupByIdtemporada();
            ...
            foreach ($query->find()->toArray(null, false, \BasePeer::TYPE_FIELDNAME) as $value) {
                ...
                $tmp['DT_RowId'] = $value['idtemporada'];
                $tmp['idtemporada'] = $value['idtemporada'];
                ...
                $tmp['options'] = '<td><div class="btn-group dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="/catalogo/temporadas/ver/' . $value['idtemporada'] . '">
                        <div class="media">
    ...
    {   
        ...
        $view_model->setTemplate('application/catalogo/temporadas/index');
    ...
    public function nuevoAction(){
        ...
        if($request->isPost()){
            ...
            foreach ($post_data as $key => $value){
                if(\TemporadaPeer::getTableMap()->hasColumn($key)){
                    $entity->setByName($key, $value, \BasePeer::TYPE_FIELDNAME);
                }
            }
            $entity->save();
            $this->flashMessenger()->addSuccessMessage('Su registro ha sido guardado satisfactoriamente.');
            return $this->redirect()->toUrl('/catalogo/temporadas');
    

        }
        
        
        $form = new \Application\Catalogo\Form\TemporadasForm();
        
        $view_model = new ViewModel();
        $view_model->setTemplate('application/catalogo/temporadas/nuevo');
        $view_model->setVariables(array(
            'form' => $form
        ));
        return $view_model;
    ...
    public function verAction(){
        ...
        if($exist){
            ...
            $entity = \TemporadaQuery::create()->findPk($id);
            ...
            $view_model = new ViewModel();
            $view_model->setTemplate('application/catalogo/temporadas/ver'); 
            $view_model->setVariables(array(
                'form' => $form,
                'entity' => $entity,
            ));
