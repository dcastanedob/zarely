...
class PedidoCompletadoController extends AbstractActionController
{
    ...
    public function getdetailsAction(){
        ...
        if($request->isPost()){
            ...
            $details = \PedidoQuery::create()->filterByPedidoEstatus('completado')->filterByIdsucursal($pedido->getIdsucursal())->filterByIdproductovariante($pedido->getIdproductovariante())->find()->toArray(null,false,\BasePeer::TYPE_FIELDNAME);
    ...
    public function serversideAction(){
        ...
        if ($request->isPost()) {
            ...
            $query->filterByPedidoEstatus('completado');
            ...
            foreach ($query->find()->toArray(null, false, \BasePeer::TYPE_FIELDNAME) as $value) {
                ...
                $tmp['options'] = '
                <a href="/pedidos/completados/ver/' . $value['idproducto'] . '">
    ...
    {   
        ...
        $view_model->setTemplate('application/pedido/completados/index');
    ...
    public function verAction()
    {
        ...
        $view_model->setTemplate('application/pedido/completados/ver');
        $view_model->setVariables(array(
            'messages' =>$this->flashMessenger(),
