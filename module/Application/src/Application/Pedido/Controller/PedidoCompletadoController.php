...
class PedidoCompletadoController extends AbstractActionController
{
    ...
    public function getdetailsAction(){
        ...
        if($request->isPost()){
            ...
            $details = \PedidoQuery::create()->filterByPedidoEstatus('completado')->filterByIdproductovariante($post_data['idvariante'])->filterByIdsucursal($post_data['idSucursal'])->find()->toArray(null,false,\BasePeer::TYPE_FIELDNAME);
