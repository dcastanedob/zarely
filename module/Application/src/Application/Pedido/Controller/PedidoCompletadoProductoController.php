...
class PedidoCompletadoProductoController extends AbstractActionController
{
    ...
    {   
        ...
        $view_model->setTemplate('application/pedido/completados-producto/index');
    ...
    public function verAction()
    {
        ...
        $view_model->setTemplate('application/pedido/completados-producto/ver');
        $view_model->setVariables(array(
            'messages' =>$this->flashMessenger(),
