...
class PedidoPendienteController extends AbstractActionController
{
    ...
    public function getdetailsAction(){
        ...
        if($request->isPost()){
            ...
            $details = \PedidoQuery::create()->filterByPedidoEstatus('pendiente')->filterByIdproductovariante($post_data['idvariante'])->filterByIdsucursal($post_data['idSucursal'])->find()->toArray(null,false,\BasePeer::TYPE_FIELDNAME);
    ...
    public function serversideAction(){
        ...
        if ($request->isPost()) {
            ...
            foreach ($query->find()->toArray(null, false, \BasePeer::TYPE_FIELDNAME) as $value) {
                ...
                $tmp['options'] = '
                <a href="/pedidos/pendientes/ver/' . $value['idproducto'] . '">
    ...
    {   
        ...
        $view_model->setTemplate('application/pedido/pendientes/index');
    ...
    public function verAction()
    {
        ...
        $view_model->setTemplate('application/pedido/pendientes/ver');
        $view_model->setVariables(array(
            'messages' =>$this->flashMessenger(),
