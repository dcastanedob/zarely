...
class PedidoPendienteProductoController extends AbstractActionController
{
    ...
    public function getdetailsAction(){
        ...
        if($request->isPost()){
            ...
            $details = \PedidoQuery::create()->filterByPedidoEstatus('pendiente')->filterByIdproductovariante($post_data['idvariante'])->find()->toArray(null,false,\BasePeer::TYPE_FIELDNAME);
    ...
    public function serversideAction(){
        ...
        if ($request->isPost()) {
            ...
            $query->filterByPedidoEstatus('pendiente');
            ...
            foreach ($query->find()->toArray(null, false, \BasePeer::TYPE_FIELDNAME) as $value) {
                ...
                $tmp['options'] = '
                <a href="/pedidos/pendientes-producto/ver/' . $value['idproducto'] . '">
            ...
            $query2 = \PedidomayoristadetalleQuery::create()->filterByPedidomayoristadetalleEstatus('pendiente')->filterByIdproducto($product_array, \Criteria::NOT_EQUAL);
    ...
    public function serversideproductovarianteAction(){
        ...
        if($request->isPost()){
            ...
            $query->withColumn('d.ColorNombre','producto_color')
            ...
            if(!empty($post_data['search']['value'])){
                ...
                $c1= $c->getNewCriterion('producto_color.colornombre', '%'.$search_value.'%', \Criteria::LIKE);
    ...
    {   
        ...
        $view_model->setTemplate('application/pedido/pendientes-producto/index');
    ...
    public function verAction()
    {
        ...
        $view_model->setTemplate('application/pedido/pendientes-producto/ver');
        $view_model->setVariables(array(
            'messages' =>$this->flashMessenger(),
    ...
    public function initializetableAction(){
        ...
        if($request->isPost()){
            ...
            $pedidos = \PedidoQuery::create()->filterByIdproducto($post_data['idproductogeneral'])->filterByPedidoEstatus('pendiente')->find();
            ...
            $mayoristas = \PedidomayoristadetalleQuery::create()->filterByIdproducto($post_data['idproductogeneral'])->filterByPedidomayoristadetalleEstatus('pendiente')->find();
