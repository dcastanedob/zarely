...
class PedidoSolicitadoController extends AbstractActionController
{
    ...
    {   
        ...
        $view_model->setTemplate('application/pedido/solicitados/index');
    ...
    public function verAction()
    {
        ...
        $view_model->setTemplate('application/pedido/solicitados/ver');
        $view_model->setVariables(array(
            'messages' =>$this->flashMessenger(),
