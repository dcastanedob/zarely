...
class PedidoTransitoController extends AbstractActionController
{
    ...
    public function getdetailsAction(){
        ...
        if($request->isPost()){
            ...
            $details = \PedidoQuery::create()->filterByPedidoEstatus('transito')->filterByIdsucursal($pedido->getIdsucursal())->filterByIdproductovariante($pedido->getIdproductovariante())->find()->toArray(null,false,\BasePeer::TYPE_FIELDNAME);
