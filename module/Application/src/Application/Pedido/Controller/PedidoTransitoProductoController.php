...
class PedidoTransitoProductoController extends AbstractActionController
{
    ...
    public function getdetailsAction(){
        ...
        if($request->isPost()){
            ...
            $details = \PedidoQuery::create()->filterByPedidoEstatus('transito')->filterByIdproductovariante($post_data['idvariante'])->find()->toArray(null,false,\BasePeer::TYPE_FIELDNAME);
    ...
    public function serversideAction(){
        ...
        if ($request->isPost()) {
            ...
            foreach ($query->find()->toArray(null, false, \BasePeer::TYPE_FIELDNAME) as $value) {
                ...
                $tmp['options'] = '
                <a href="/pedidos/transitos-producto/ver/' . $value['idproducto'] . '">
            ...
            $query2 = \PedidomayoristadetalleQuery::create()->filterByPedidomayoristadetalleEstatus('transito')->filterByIdproducto($product_array, \Criteria::NOT_EQUAL);
    ...
    {   
        ...
        $view_model->setTemplate('application/pedido/transitos-producto/index');
    ...
    public function verAction()
    {
        ...
        $view_model->setTemplate('application/pedido/transitos-producto/ver');
        $view_model->setVariables(array(
            'messages' =>$this->flashMessenger(),
    ...
    public function initializetableAction(){
        ...
        if($request->isPost()){
            ...
            $mayoristas = \PedidomayoristadetalleQuery::create()->filterByIdproducto($post_data['idproductogeneral'])->filterByPedidomayoristadetalleEstatus('transito')->find();
