                ...
                foreach ($producto_variante as $variante) {
                    ...
                    if($variante['ProductovarianteTalla'] == $minimo)
                    {
                        ...
                        foreach ($sucursales as $key => $value) {
                            ...
                            {
                                $tmp[$name] = '<input type="hidden" name="idsucursal" value="'.$value->getIdsucursal().'">$ <input type="text" name="precio" placeholder="'.number_format($sucursal_producto->getProductosucursalPrecioventa(),2).'" value="'.number_format($sucursal_producto->getProductosucursalPrecioventa(),2).'" >';
                            }else
                            {
