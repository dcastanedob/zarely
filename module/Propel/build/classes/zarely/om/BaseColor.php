...
abstract class BaseColor extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the color_nombre field.
     * @var        string
     */
    ...
    /**
     * Get the [color_nombre] column value.
     *
     * @return string
     */
    ...
    public function setIdcolor($v)
    {
        ...
        if ($this->idcolor !== $v) {
            $this->idcolor = $v;
            $this->modifiedColumns[] = ColorPeer::IDCOLOR;
        }
    ...
    /**
     * Set the value of [color_nombre] column.
     *
     * @param  string $v new value
     * @return Color The current object (for fluent API support)
     */
    public function setColorNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->color_nombre !== $v) {
            $this->color_nombre = $v;
            $this->modifiedColumns[] = ColorPeer::COLOR_NOMBRE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idcolor = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->color_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = ColorPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ColorPeer::IDCOLOR)) {
            $modifiedColumns[':p' . $index++]  = '`idcolor`';
        }
        if ($this->isColumnModified(ColorPeer::COLOR_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`color_nombre`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idcolor`':
                        ...
                        break;
                    case '`color_nombre`':
                        $stmt->bindValue($identifier, $this->color_nombre, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdcolor($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setColorNombre($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ColorPeer::IDCOLOR)) $criteria->add(ColorPeer::IDCOLOR, $this->idcolor);
        if ($this->isColumnModified(ColorPeer::COLOR_NOMBRE)) $criteria->add(ColorPeer::COLOR_NOMBRE, $this->color_nombre);
    ...
    {
        $criteria = new Criteria(ColorPeer::DATABASE_NAME);
        $criteria->add(ColorPeer::IDCOLOR, $this->idcolor);
    ...
    {
        $copyObj->setColorNombre($this->getColorNombre());
    ...
    public function setProductocolors(PropelCollection $productocolors, PropelPDO $con = null)
    {
        ...
        foreach ($productocolorsToDelete as $productocolorRemoved) {
            $productocolorRemoved->setColor(null);
        }
     ...
     * @return PropelObjectCollection|Productocolor[] List of Productocolor objects
     */
    public function getProductocolorsJoinProducto($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProductocolorQuery::create(null, $criteria);
