...
/**
 * Base static class for performing query and update operations on the 'color' table.
 *
 *
 *
...
abstract class BaseColorPeer
{
    ...
    /** the column name for the color_nombre field */
    const COLOR_NOMBRE = 'color.color_nombre';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idcolor', 'ColorNombre', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcolor', 'colorNombre', ),
        BasePeer::TYPE_COLNAME => array (ColorPeer::IDCOLOR, ColorPeer::COLOR_NOMBRE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCOLOR', 'COLOR_NOMBRE', ),
        BasePeer::TYPE_FIELDNAME => array ('idcolor', 'color_nombre', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idcolor' => 0, 'ColorNombre' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcolor' => 0, 'colorNombre' => 1, ),
        BasePeer::TYPE_COLNAME => array (ColorPeer::IDCOLOR => 0, ColorPeer::COLOR_NOMBRE => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCOLOR' => 0, 'COLOR_NOMBRE' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('idcolor' => 0, 'color_nombre' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ColorPeer::IDCOLOR);
            $criteria->addSelectColumn(ColorPeer::COLOR_NOMBRE);
        } else {
            $criteria->addSelectColumn($alias . '.idcolor');
            $criteria->addSelectColumn($alias . '.color_nombre');
        }
    }
    ...
    {
        // Invalidate objects in ProductocolorPeer instance pool,
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ColorPeer::IDCOLOR) && $criteria->keyContainsValue(ColorPeer::IDCOLOR) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.ColorPeer::IDCOLOR.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ColorPeer::IDCOLOR);
            $value = $criteria->remove(ColorPeer::IDCOLOR);
            if ($value) {
                $selectCriteria->add(ColorPeer::IDCOLOR, $value, $comparison);
            } else {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += ColorPeer::doOnDeleteCascade(new Criteria(ColorPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ColorPeer::IDCOLOR, (array) $values, Criteria::IN);
        }
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += ColorPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = ColorPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related Productocolor objects
            $criteria = new Criteria(ProductocolorPeer::DATABASE_NAME);

            $criteria->add(ProductocolorPeer::IDCOLOR, $obj->getIdcolor());
            $affectedRows += ProductocolorPeer::doDelete($criteria, $con);
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ColorPeer::DATABASE_NAME);
        $criteria->add(ColorPeer::IDCOLOR, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ColorPeer::DATABASE_NAME);
            $criteria->add(ColorPeer::IDCOLOR, $pks, Criteria::IN);
