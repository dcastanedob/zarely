...
abstract class BaseCompradetalle extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the compradetalle_preciounitario field.
     * @var        string
     */
    protected $compradetalle_preciounitario;
    ...
    /**
     * Get the [compradetalle_preciounitario] column value.
     *
     * @return string
     */
    public function getCompradetallePreciounitario()
    {

        return $this->compradetalle_preciounitario;
    }
    ...
    public function setIdproductovariante($v)
    {
        ...
        if ($this->idproductovariante !== $v) {
            ...
            $this->modifiedColumns[] = CompradetallePeer::IDPRODUCTOVARIANTE;
        }
    ...
    /**
     * Set the value of [compradetalle_preciounitario] column.
     *
     * @param  string $v new value
     * @return Compradetalle The current object (for fluent API support)
     */
    public function setCompradetallePreciounitario($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->compradetalle_preciounitario !== $v) {
            $this->compradetalle_preciounitario = $v;
            $this->modifiedColumns[] = CompradetallePeer::COMPRADETALLE_PRECIOUNITARIO;
        }


        return $this;
    } // setCompradetallePreciounitario()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CompradetallePeer::IDPRODUCTOVARIANTE)) {
        ...
        if ($this->isColumnModified(CompradetallePeer::COMPRADETALLE_PRECIOUNITARIO)) {
            $modifiedColumns[':p' . $index++]  = '`compradetalle_preciounitario`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`compradetalle_cantidad`':
                        ...
                        break;
                    case '`compradetalle_preciounitario`':
                        $stmt->bindValue($identifier, $this->compradetalle_preciounitario, PDO::PARAM_STR);
                        break;
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                return $this->getCompradetallePreciounitario();
                break;
            case 5:
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                $this->setCompradetallePreciounitario($value);
                break;
            case 5:
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompradetallePeer::IDPRODUCTOVARIANTE)) $criteria->add(CompradetallePeer::IDPRODUCTOVARIANTE, $this->idproductovariante);
    ...
    public function getProductovariante(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProductovariante === null && ($this->idproductovariante !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProductovariante->addCompradetalles($this);
             */
        }
