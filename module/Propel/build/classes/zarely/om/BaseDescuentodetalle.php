...
/**
 * Base class that represents a row from the 'descuentodetalle' table.
 *
 *
 *
 * @package    propel.generator.zarely.om
 */
abstract class BaseDescuentodetalle extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DescuentodetallePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DescuentodetallePeer
     */
    ...
    /**
     * The value for the iddescuentodetalle field.
     * @var        int
     */
    protected $iddescuentodetalle;
    ...
    /**
     * Get the [iddescuentodetalle] column value.
     *
     * @return int
     */
    public function getIddescuentodetalle()
    {

        return $this->iddescuentodetalle;
    }
    ...
    /**
     * Set the value of [iddescuentodetalle] column.
     *
     * @param  int $v new value
     * @return Descuentodetalle The current object (for fluent API support)
     */
    public function setIddescuentodetalle($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->iddescuentodetalle !== $v) {
            $this->iddescuentodetalle = $v;
            $this->modifiedColumns[] = DescuentodetallePeer::IDDESCUENTODETALLE;
        }


        return $this;
    } // setIddescuentodetalle()
    ...
    public function setIddescuento($v)
    {
        ...
        if ($this->iddescuento !== $v) {
            $this->iddescuento = $v;
            $this->modifiedColumns[] = DescuentodetallePeer::IDDESCUENTO;
        }
    ...
    public function setIdproducto($v)
    {
        ...
        if ($this->idproducto !== $v) {
            $this->idproducto = $v;
            $this->modifiedColumns[] = DescuentodetallePeer::IDPRODUCTO;
        }
    ...
    public function setIdmarca($v)
    {
        ...
        if ($this->idmarca !== $v) {
            $this->idmarca = $v;
            $this->modifiedColumns[] = DescuentodetallePeer::IDMARCA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->iddescuentodetalle = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DescuentodetallePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DescuentodetalleQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DescuentodetallePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DescuentodetallePeer::IDDESCUENTODETALLE)) {
            $modifiedColumns[':p' . $index++]  = '`iddescuentodetalle`';
        }
        if ($this->isColumnModified(DescuentodetallePeer::IDDESCUENTO)) {
            $modifiedColumns[':p' . $index++]  = '`iddescuento`';
        }
        if ($this->isColumnModified(DescuentodetallePeer::IDPRODUCTO)) {
        ...
        $sql = sprintf(
            'INSERT INTO `descuentodetalle` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`iddescuentodetalle`':
                        $stmt->bindValue($identifier, $this->iddescuentodetalle, PDO::PARAM_INT);
                        break;
                    case '`iddescuento`':
    ...
    {
        $pos = DescuentodetallePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIddescuentodetalle();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Descuentodetalle'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Descuentodetalle'][$this->getPrimaryKey()] = true;
        $keys = DescuentodetallePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIddescuentodetalle(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIddescuentodetalle($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIddescuentodetalle($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DescuentodetallePeer::IDDESCUENTODETALLE)) $criteria->add(DescuentodetallePeer::IDDESCUENTODETALLE, $this->iddescuentodetalle);
    ...
    {
        $criteria = new Criteria(DescuentodetallePeer::DATABASE_NAME);
        $criteria->add(DescuentodetallePeer::IDDESCUENTODETALLE, $this->iddescuentodetalle);
    ...
    /**
     * Generic method to set the primary key (iddescuentodetalle column).
     *
    ...
    {
        $this->setIddescuentodetalle($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIddescuentodetalle();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Descuentodetalle (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIddescuentodetalle(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Descuentodetalle Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DescuentodetallePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DescuentodetallePeer();
        }
    ...
    public function getDescuento(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDescuento === null && ($this->iddescuento !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDescuento->addDescuentodetalles($this);
             */
        }
    ...
    public function getMarca(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMarca === null && ($this->idmarca !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMarca->addDescuentodetalles($this);
             */
        }
    ...
    public function getProducto(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProducto === null && ($this->idproducto !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProducto->addDescuentodetalles($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DescuentodetallePeer::DEFAULT_STRING_FORMAT);
    }
