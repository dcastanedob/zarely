...
abstract class BaseDevoluciondetalle extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the devoluciondetalle_preciounitario field.
     * @var        string
     */
    protected $devoluciondetalle_preciounitario;
    ...
    /**
     * Get the [devoluciondetalle_preciounitario] column value.
     *
     * @return string
     */
    public function getDevoluciondetallePreciounitario()
    {

        return $this->devoluciondetalle_preciounitario;
    }
    ...
    public function setIdproductovariante($v)
    {
        ...
        if ($this->idproductovariante !== $v) {
            ...
            $this->modifiedColumns[] = DevoluciondetallePeer::IDPRODUCTOVARIANTE;
        }
    ...
    /**
     * Set the value of [devoluciondetalle_preciounitario] column.
     *
     * @param  string $v new value
     * @return Devoluciondetalle The current object (for fluent API support)
     */
    public function setDevoluciondetallePreciounitario($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->devoluciondetalle_preciounitario !== $v) {
            $this->devoluciondetalle_preciounitario = $v;
            $this->modifiedColumns[] = DevoluciondetallePeer::DEVOLUCIONDETALLE_PRECIOUNITARIO;
        }


        return $this;
    } // setDevoluciondetallePreciounitario()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->devoluciondetalle_cantidad = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->devoluciondetalle_preciounitario = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->devoluciondetalle_subtotal = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = DevoluciondetallePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DevoluciondetallePeer::IDPRODUCTOVARIANTE)) {
        ...
        if ($this->isColumnModified(DevoluciondetallePeer::DEVOLUCIONDETALLE_PRECIOUNITARIO)) {
            $modifiedColumns[':p' . $index++]  = '`devoluciondetalle_preciounitario`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`devoluciondetalle_cantidad`':
                        ...
                        break;
                    case '`devoluciondetalle_preciounitario`':
                        $stmt->bindValue($identifier, $this->devoluciondetalle_preciounitario, PDO::PARAM_STR);
                        break;
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                return $this->getDevoluciondetallePreciounitario();
                break;
            case 5:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getDevoluciondetalleCantidad(),
            $keys[4] => $this->getDevoluciondetallePreciounitario(),
            $keys[5] => $this->getDevoluciondetalleSubtotal(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                $this->setDevoluciondetallePreciounitario($value);
                break;
            case 5:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setDevoluciondetalleCantidad($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setDevoluciondetallePreciounitario($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setDevoluciondetalleSubtotal($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DevoluciondetallePeer::IDPRODUCTOVARIANTE)) $criteria->add(DevoluciondetallePeer::IDPRODUCTOVARIANTE, $this->idproductovariante);
        ...
        if ($this->isColumnModified(DevoluciondetallePeer::DEVOLUCIONDETALLE_PRECIOUNITARIO)) $criteria->add(DevoluciondetallePeer::DEVOLUCIONDETALLE_PRECIOUNITARIO, $this->devoluciondetalle_preciounitario);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDevoluciondetallePreciounitario($this->getDevoluciondetallePreciounitario());
    ...
    public function getProductovariante(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProductovariante === null && ($this->idproductovariante !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProductovariante->addDevoluciondetalles($this);
             */
        }
    ...
    public function clear()
    {
        ...
        $this->devoluciondetalle_preciounitario = null;
