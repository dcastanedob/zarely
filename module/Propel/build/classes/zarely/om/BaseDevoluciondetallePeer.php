...
abstract class BaseDevoluciondetallePeer
{
    ...
    const IDPRODUCTOVARIANTE = 'devoluciondetalle.idproductovariante';
    ...
    /** the column name for the devoluciondetalle_preciounitario field */
    const DEVOLUCIONDETALLE_PRECIOUNITARIO = 'devoluciondetalle.devoluciondetalle_preciounitario';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Iddevoluciondetalle', 'Iddevolucion', 'Idproductovariante', 'DevoluciondetalleCantidad', 'DevoluciondetallePreciounitario', 'DevoluciondetalleSubtotal', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('iddevoluciondetalle', 'iddevolucion', 'idproductovariante', 'devoluciondetalleCantidad', 'devoluciondetallePreciounitario', 'devoluciondetalleSubtotal', ),
        BasePeer::TYPE_COLNAME => array (DevoluciondetallePeer::IDDEVOLUCIONDETALLE, DevoluciondetallePeer::IDDEVOLUCION, DevoluciondetallePeer::IDPRODUCTOVARIANTE, DevoluciondetallePeer::DEVOLUCIONDETALLE_CANTIDAD, DevoluciondetallePeer::DEVOLUCIONDETALLE_PRECIOUNITARIO, DevoluciondetallePeer::DEVOLUCIONDETALLE_SUBTOTAL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDDEVOLUCIONDETALLE', 'IDDEVOLUCION', 'IDPRODUCTOVARIANTE', 'DEVOLUCIONDETALLE_CANTIDAD', 'DEVOLUCIONDETALLE_PRECIOUNITARIO', 'DEVOLUCIONDETALLE_SUBTOTAL', ),
        BasePeer::TYPE_FIELDNAME => array ('iddevoluciondetalle', 'iddevolucion', 'idproductovariante', 'devoluciondetalle_cantidad', 'devoluciondetalle_preciounitario', 'devoluciondetalle_subtotal', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Iddevoluciondetalle' => 0, 'Iddevolucion' => 1, 'Idproductovariante' => 2, 'DevoluciondetalleCantidad' => 3, 'DevoluciondetallePreciounitario' => 4, 'DevoluciondetalleSubtotal' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('iddevoluciondetalle' => 0, 'iddevolucion' => 1, 'idproductovariante' => 2, 'devoluciondetalleCantidad' => 3, 'devoluciondetallePreciounitario' => 4, 'devoluciondetalleSubtotal' => 5, ),
        BasePeer::TYPE_COLNAME => array (DevoluciondetallePeer::IDDEVOLUCIONDETALLE => 0, DevoluciondetallePeer::IDDEVOLUCION => 1, DevoluciondetallePeer::IDPRODUCTOVARIANTE => 2, DevoluciondetallePeer::DEVOLUCIONDETALLE_CANTIDAD => 3, DevoluciondetallePeer::DEVOLUCIONDETALLE_PRECIOUNITARIO => 4, DevoluciondetallePeer::DEVOLUCIONDETALLE_SUBTOTAL => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDDEVOLUCIONDETALLE' => 0, 'IDDEVOLUCION' => 1, 'IDPRODUCTOVARIANTE' => 2, 'DEVOLUCIONDETALLE_CANTIDAD' => 3, 'DEVOLUCIONDETALLE_PRECIOUNITARIO' => 4, 'DEVOLUCIONDETALLE_SUBTOTAL' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('iddevoluciondetalle' => 0, 'iddevolucion' => 1, 'idproductovariante' => 2, 'devoluciondetalle_cantidad' => 3, 'devoluciondetalle_preciounitario' => 4, 'devoluciondetalle_subtotal' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DevoluciondetallePeer::IDPRODUCTOVARIANTE);
            $criteria->addSelectColumn(DevoluciondetallePeer::DEVOLUCIONDETALLE_CANTIDAD);
            $criteria->addSelectColumn(DevoluciondetallePeer::DEVOLUCIONDETALLE_PRECIOUNITARIO);
            ...
            $criteria->addSelectColumn($alias . '.devoluciondetalle_preciounitario');
    ...
    public static function doCountJoinProductovariante(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(DevoluciondetallePeer::IDPRODUCTOVARIANTE, ProductovariantePeer::IDPRODUCTOVARIANTE, $join_behavior);
    ...
    /**
     * Selects a collection of Devoluciondetalle objects pre-filled with their Productovariante objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Devoluciondetalle objects.
    ...
    public static function doSelectJoinProductovariante(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Devoluciondetalle) to $obj2 (Productovariante)
                $obj2->addDevoluciondetalle($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Devoluciondetalle) to the collection in $obj3 (Productovariante)
    ...
    public static function doSelectJoinAllExceptDevolucion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = DevoluciondetallePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Devoluciondetalle) to the collection in $obj2 (Productovariante)
                $obj2->addDevoluciondetalle($obj1);
    ...
    /**
     * Selects a collection of Devoluciondetalle objects pre-filled with all related objects except Productovariante.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
