...
abstract class BaseMaterial extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the material_nombre field.
     * @var        string
     */
    ...
    /**
     * Get the [material_nombre] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [material_nombre] column.
     *
     * @param  string $v new value
     * @return Material The current object (for fluent API support)
     */
    public function setMaterialNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->material_nombre !== $v) {
            $this->material_nombre = $v;
            $this->modifiedColumns[] = MaterialPeer::MATERIAL_NOMBRE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->material_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = MaterialPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MaterialPeer::MATERIAL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`material_nombre`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`material_nombre`':
                        $stmt->bindValue($identifier, $this->material_nombre, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setMaterialNombre($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MaterialPeer::MATERIAL_NOMBRE)) $criteria->add(MaterialPeer::MATERIAL_NOMBRE, $this->material_nombre);
    ...
    {
        $copyObj->setMaterialNombre($this->getMaterialNombre());
    ...
    public function setProductomaterials(PropelCollection $productomaterials, PropelPDO $con = null)
    {
        ...
        foreach ($productomaterialsToDelete as $productomaterialRemoved) {
            $productomaterialRemoved->setMaterial(null);
        }
    ...
    protected function doAddProductomaterial($productomaterial)
    {
        ...
        $productomaterial->setMaterial($this);
    }
    ...
    public function removeProductomaterial($productomaterial)
    {
        if ($this->getProductomaterials()->contains($productomaterial)) {
            ...
            $productomaterial->setMaterial(null);
        }
     ...
     * @return PropelObjectCollection|Productomaterial[] List of Productomaterial objects
     */
    public function getProductomaterialsJoinProducto($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProductomaterialQuery::create(null, $criteria);
