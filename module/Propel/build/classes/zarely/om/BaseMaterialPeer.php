...
abstract class BaseMaterialPeer
{
    ...
    /** the column name for the material_nombre field */
    const MATERIAL_NOMBRE = 'material.material_nombre';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idmaterial', 'MaterialNombre', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idmaterial', 'materialNombre', ),
        BasePeer::TYPE_COLNAME => array (MaterialPeer::IDMATERIAL, MaterialPeer::MATERIAL_NOMBRE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDMATERIAL', 'MATERIAL_NOMBRE', ),
        BasePeer::TYPE_FIELDNAME => array ('idmaterial', 'material_nombre', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idmaterial' => 0, 'MaterialNombre' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idmaterial' => 0, 'materialNombre' => 1, ),
        BasePeer::TYPE_COLNAME => array (MaterialPeer::IDMATERIAL => 0, MaterialPeer::MATERIAL_NOMBRE => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDMATERIAL' => 0, 'MATERIAL_NOMBRE' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('idmaterial' => 0, 'material_nombre' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MaterialPeer::MATERIAL_NOMBRE);
        } else {
            $criteria->addSelectColumn($alias . '.idmaterial');
            $criteria->addSelectColumn($alias . '.material_nombre');
        }
    }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(ProductomaterialPeer::IDMATERIAL, $obj->getIdmaterial());
