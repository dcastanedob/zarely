...
abstract class BasePedidoPeer
{
    ...
    /** the column name for the pedido_fecha field */
    const PEDIDO_FECHA = 'pedido.pedido_fecha';

    /** the column name for the idproducto field */
    const IDPRODUCTO = 'pedido.idproducto';

    /** the column name for the pedido_cantidad field */
    const PEDIDO_CANTIDAD = 'pedido.pedido_cantidad';

    /** the column name for the idproductovariante field */
    const IDPRODUCTOVARIANTE = 'pedido.idproductovariante';

    /** the column name for the pedido_nota field */
    const PEDIDO_NOTA = 'pedido.pedido_nota';

    /** the column name for the pedido_estatus field */
    const PEDIDO_ESTATUS = 'pedido.pedido_estatus';

    /** The enumerated values for the pedido_estatus field */
    const PEDIDO_ESTATUS_PENDIENTE = 'pendiente';
    const PEDIDO_ESTATUS_SOLICITADO = 'solicitado';
    const PEDIDO_ESTATUS_TRANSITO = 'transito';
    const PEDIDO_ESTATUS_COMPLETADO = 'completado';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Pedido objects.
     ...
     * e.g. PedidoPeer::$fieldNames[PedidoPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idpedido', 'Idsucursal', 'PedidoFecha', 'Idproducto', 'PedidoCantidad', 'Idproductovariante', 'PedidoNota', 'PedidoEstatus', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idpedido', 'idsucursal', 'pedidoFecha', 'idproducto', 'pedidoCantidad', 'idproductovariante', 'pedidoNota', 'pedidoEstatus', ),
        BasePeer::TYPE_COLNAME => array (PedidoPeer::IDPEDIDO, PedidoPeer::IDSUCURSAL, PedidoPeer::PEDIDO_FECHA, PedidoPeer::IDPRODUCTO, PedidoPeer::PEDIDO_CANTIDAD, PedidoPeer::IDPRODUCTOVARIANTE, PedidoPeer::PEDIDO_NOTA, PedidoPeer::PEDIDO_ESTATUS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPEDIDO', 'IDSUCURSAL', 'PEDIDO_FECHA', 'IDPRODUCTO', 'PEDIDO_CANTIDAD', 'IDPRODUCTOVARIANTE', 'PEDIDO_NOTA', 'PEDIDO_ESTATUS', ),
        BasePeer::TYPE_FIELDNAME => array ('idpedido', 'idsucursal', 'pedido_fecha', 'idproducto', 'pedido_cantidad', 'idproductovariante', 'pedido_nota', 'pedido_estatus', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. PedidoPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idpedido' => 0, 'Idsucursal' => 1, 'PedidoFecha' => 2, 'Idproducto' => 3, 'PedidoCantidad' => 4, 'Idproductovariante' => 5, 'PedidoNota' => 6, 'PedidoEstatus' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idpedido' => 0, 'idsucursal' => 1, 'pedidoFecha' => 2, 'idproducto' => 3, 'pedidoCantidad' => 4, 'idproductovariante' => 5, 'pedidoNota' => 6, 'pedidoEstatus' => 7, ),
        BasePeer::TYPE_COLNAME => array (PedidoPeer::IDPEDIDO => 0, PedidoPeer::IDSUCURSAL => 1, PedidoPeer::PEDIDO_FECHA => 2, PedidoPeer::IDPRODUCTO => 3, PedidoPeer::PEDIDO_CANTIDAD => 4, PedidoPeer::IDPRODUCTOVARIANTE => 5, PedidoPeer::PEDIDO_NOTA => 6, PedidoPeer::PEDIDO_ESTATUS => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPEDIDO' => 0, 'IDSUCURSAL' => 1, 'PEDIDO_FECHA' => 2, 'IDPRODUCTO' => 3, 'PEDIDO_CANTIDAD' => 4, 'IDPRODUCTOVARIANTE' => 5, 'PEDIDO_NOTA' => 6, 'PEDIDO_ESTATUS' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('idpedido' => 0, 'idsucursal' => 1, 'pedido_fecha' => 2, 'idproducto' => 3, 'pedido_cantidad' => 4, 'idproductovariante' => 5, 'pedido_nota' => 6, 'pedido_estatus' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );

    /** The enumerated values for this table */
    protected static $enumValueSets = array(
        PedidoPeer::PEDIDO_ESTATUS => array(
            PedidoPeer::PEDIDO_ESTATUS_PENDIENTE,
            PedidoPeer::PEDIDO_ESTATUS_SOLICITADO,
            PedidoPeer::PEDIDO_ESTATUS_TRANSITO,
            PedidoPeer::PEDIDO_ESTATUS_COMPLETADO,
        ),
    );
    ...
    {
        $toNames = PedidoPeer::getFieldNames($toType);
        $key = isset(PedidoPeer::$fieldKeys[$fromType][$name]) ? PedidoPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PedidoPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PedidoPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PedidoPeer::$fieldNames[$type];
    }
    ...
    {
      return PedidoPeer::$enumValueSets;
    }
    ...
    {
        $valueSets = PedidoPeer::getValueSets();
    ...
    {
        $values = PedidoPeer::getValueSet($colname);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PedidoPeer::IDPEDIDO);
            $criteria->addSelectColumn(PedidoPeer::IDSUCURSAL);
            $criteria->addSelectColumn(PedidoPeer::PEDIDO_FECHA);
            $criteria->addSelectColumn(PedidoPeer::IDPRODUCTO);
            $criteria->addSelectColumn(PedidoPeer::PEDIDO_CANTIDAD);
            $criteria->addSelectColumn(PedidoPeer::IDPRODUCTOVARIANTE);
            $criteria->addSelectColumn(PedidoPeer::PEDIDO_NOTA);
            $criteria->addSelectColumn(PedidoPeer::PEDIDO_ESTATUS);
        } else {
            $criteria->addSelectColumn($alias . '.idpedido');
            $criteria->addSelectColumn($alias . '.idsucursal');
            $criteria->addSelectColumn($alias . '.pedido_fecha');
            $criteria->addSelectColumn($alias . '.idproducto');
            $criteria->addSelectColumn($alias . '.pedido_cantidad');
            $criteria->addSelectColumn($alias . '.idproductovariante');
            $criteria->addSelectColumn($alias . '.pedido_nota');
            $criteria->addSelectColumn($alias . '.pedido_estatus');
        }
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PedidoPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PedidoPeer::DATABASE_NAME);
     ...
     *
     * @param Pedido $obj A Pedido object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getIdpedido();
            } // if key === null
            PedidoPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(PedidoPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PedidoPeer::$instances[$key])) {
                return PedidoPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (PedidoPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        PedidoPeer::$instances = array();
    }
    ...
    {
        $key = PedidoPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = PedidoPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + PedidoPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PedidoPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinProducto(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PedidoPeer::IDPRODUCTO, ProductoPeer::IDPRODUCTO, $join_behavior);
    ...
    public static function doCountJoinProductovariante(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PedidoPeer::IDPRODUCTOVARIANTE, ProductovariantePeer::IDPRODUCTOVARIANTE, $join_behavior);
    ...
    public static function doCountJoinSucursal(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PedidoPeer::IDSUCURSAL, SucursalPeer::IDSUCURSAL, $join_behavior);
    ...
    /**
     * Selects a collection of Pedido objects pre-filled with their Producto objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinProducto(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PedidoPeer::addSelectColumns($criteria);
        $startcol = PedidoPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Pedido) to $obj2 (Producto)
                $obj2->addPedido($obj1);
    ...
    /**
     * Selects a collection of Pedido objects pre-filled with their Productovariante objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Pedido objects.
    ...
    public static function doSelectJoinProductovariante(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Pedido) to $obj2 (Productovariante)
                $obj2->addPedido($obj1);
    ...
    /**
     * Selects a collection of Pedido objects pre-filled with their Sucursal objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Pedido objects.
    ...
    public static function doSelectJoinSucursal(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Pedido) to $obj2 (Sucursal)
                $obj2->addPedido($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PedidoPeer::addSelectColumns($criteria);
        $startcol2 = PedidoPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Pedido) to the collection in $obj2 (Producto)
                $obj2->addPedido($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Pedido) to the collection in $obj3 (Productovariante)
                $obj3->addPedido($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (Pedido) to the collection in $obj4 (Sucursal)
                $obj4->addPedido($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Pedido objects pre-filled with all related objects except Producto.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptProducto(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = PedidoPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Pedido) to the collection in $obj2 (Productovariante)
                $obj2->addPedido($obj1);
                ...
                // Add the $obj1 (Pedido) to the collection in $obj3 (Sucursal)
                $obj3->addPedido($obj1);
    ...
    /**
     * Selects a collection of Pedido objects pre-filled with all related objects except Productovariante.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Pedido objects pre-filled with all related objects except Sucursal.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(PedidoPeer::DATABASE_NAME)->getTable(PedidoPeer::TABLE_NAME);
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(PedidoPeer::IDPEDIDO) && $criteria->keyContainsValue(PedidoPeer::IDPEDIDO) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Pedido or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PedidoPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(PedidoPeer::IDPEDIDO);
            $value = $criteria->remove(PedidoPeer::IDPEDIDO);
            if ($value) {
                $selectCriteria->add(PedidoPeer::IDPEDIDO, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(PedidoPeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(PedidoPeer::TABLE_NAME, $con, PedidoPeer::DATABASE_NAME);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PedidoPeer::IDPEDIDO, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(PedidoPeer::DATABASE_NAME);
        $criteria->add(PedidoPeer::IDPEDIDO, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PedidoPeer::DATABASE_NAME);
            $criteria->add(PedidoPeer::IDPEDIDO, $pks, Criteria::IN);
