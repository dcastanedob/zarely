 ...
 *
 * @method ProductoQuery leftJoinNotificacion($relationAlias = null) Adds a LEFT JOIN clause to the query using the Notificacion relation
 * @method ProductoQuery rightJoinNotificacion($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Notificacion relation
 * @method ProductoQuery innerJoinNotificacion($relationAlias = null) Adds a INNER JOIN clause to the query using the Notificacion relation
 *
 ...
 *
 * @method ProductoQuery leftJoinPromociondetalle($relationAlias = null) Adds a LEFT JOIN clause to the query using the Promociondetalle relation
 * @method ProductoQuery rightJoinPromociondetalle($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Promociondetalle relation
 * @method ProductoQuery innerJoinPromociondetalle($relationAlias = null) Adds a INNER JOIN clause to the query using the Promociondetalle relation
 *
 ...
 * @method Producto findOneByProductoCosto(int $producto_costo) Return the first Producto filtered by the producto_costo column
 *
 ...
 * @method array findByProductoCosto(int $producto_costo) Return Producto objects filtered by the producto_costo column
 *
...
abstract class BaseProductoQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `idproducto`, `producto_modelo`, `idmarca`, `idtemporada`, `producto_comisionable`, `idproveedor`, `producto_dirigidoa`, `producto_precioventa`, `producto_preciomayoreo`, `producto_minimo`, `producto_reorden`, `idtipocalzado`, `producto_descripcion`, `producto_costo` FROM `producto` WHERE `idproducto` = :p0';
        try {
    ...
    public function filterByNotificacion($notificacion, $comparison = null)
    {
        if ($notificacion instanceof Notificacion) {
            return $this
                ->addUsingAlias(ProductoPeer::IDPRODUCTO, $notificacion->getIdproducto(), $comparison);
    ...
    public function filterByPromociondetalle($promociondetalle, $comparison = null)
    {
        if ($promociondetalle instanceof Promociondetalle) {
            return $this
                ->addUsingAlias(ProductoPeer::IDPRODUCTO, $promociondetalle->getIdproducto(), $comparison);
