...
abstract class BaseSucursalPeer
{
    ...
    /** the column name for the sucursal_nombrecomercial field */
    const SUCURSAL_NOMBRECOMERCIAL = 'sucursal.sucursal_nombrecomercial';

    /** the column name for the sucursal_razonsocial field */
    const SUCURSAL_RAZONSOCIAL = 'sucursal.sucursal_razonsocial';

    /** the column name for the sucursal_calle field */
    const SUCURSAL_CALLE = 'sucursal.sucursal_calle';

    /** the column name for the sucursal_numexterno field */
    const SUCURSAL_NUMEXTERNO = 'sucursal.sucursal_numexterno';

    /** the column name for the sucursal_numinterior field */
    const SUCURSAL_NUMINTERIOR = 'sucursal.sucursal_numinterior';

    /** the column name for the sucursal_colonia field */
    const SUCURSAL_COLONIA = 'sucursal.sucursal_colonia';

    /** the column name for the sucursal_codigopostal field */
    const SUCURSAL_CODIGOPOSTAL = 'sucursal.sucursal_codigopostal';

    /** the column name for the sucursal_ciudad field */
    const SUCURSAL_CIUDAD = 'sucursal.sucursal_ciudad';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SucursalPeer::SUCURSAL_NOMBRECOMERCIAL);
            $criteria->addSelectColumn(SucursalPeer::SUCURSAL_RAZONSOCIAL);
            $criteria->addSelectColumn(SucursalPeer::SUCURSAL_CALLE);
            $criteria->addSelectColumn(SucursalPeer::SUCURSAL_NUMEXTERNO);
            $criteria->addSelectColumn(SucursalPeer::SUCURSAL_NUMINTERIOR);
            $criteria->addSelectColumn(SucursalPeer::SUCURSAL_COLONIA);
            ...
            $criteria->addSelectColumn($alias . '.sucursal_razonsocial');
            $criteria->addSelectColumn($alias . '.sucursal_calle');
            $criteria->addSelectColumn($alias . '.sucursal_numexterno');
            $criteria->addSelectColumn($alias . '.sucursal_numinterior');
            $criteria->addSelectColumn($alias . '.sucursal_colonia');
