...
/**
 * Base class that represents a row from the 'sucursalempleado' table.
 *
 *
 *
 * @package    propel.generator.zarely.om
 */
abstract class BaseSucursalempleado extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'SucursalempleadoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SucursalempleadoPeer
     */
    ...
    /**
     * The value for the idsucursalempleado field.
     * @var        int
     */
    protected $idsucursalempleado;
     ...
     * @var        boolean
     */
    protected $sucursalempleado_estatus;
    ...
    /**
     * Get the [idsucursalempleado] column value.
     *
     * @return int
     */
    public function getIdsucursalempleado()
    {

        return $this->idsucursalempleado;
    }
    ...
    /**
     * Get the [sucursalempleado_estatus] column value.
     *
     * @return boolean
     */
    public function getSucursalempleadoEstatus()
    {

        return $this->sucursalempleado_estatus;
    }

    /**
     * Set the value of [idsucursalempleado] column.
     *
     * @param  int $v new value
     * @return Sucursalempleado The current object (for fluent API support)
     */
    public function setIdsucursalempleado($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idsucursalempleado !== $v) {
            $this->idsucursalempleado = $v;
            $this->modifiedColumns[] = SucursalempleadoPeer::IDSUCURSALEMPLEADO;
        }


        return $this;
    } // setIdsucursalempleado()
    ...
    public function setIdsucursal($v)
    {
        ...
        if ($this->idsucursal !== $v) {
            $this->idsucursal = $v;
            $this->modifiedColumns[] = SucursalempleadoPeer::IDSUCURSAL;
        }
    ...
    public function setIdempleado($v)
    {
        ...
        if ($this->idempleado !== $v) {
            $this->idempleado = $v;
            $this->modifiedColumns[] = SucursalempleadoPeer::IDEMPLEADO;
        }
     ...
     * @return Sucursalempleado The current object (for fluent API support)
     */
    public function setSucursalempleadoEstatus($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->sucursalempleado_estatus !== $v) {
            $this->sucursalempleado_estatus = $v;
            $this->modifiedColumns[] = SucursalempleadoPeer::SUCURSALEMPLEADO_ESTATUS;
        }


        return $this;
    } // setSucursalempleadoEstatus()
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SucursalempleadoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SucursalempleadoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SucursalempleadoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = SucursalempleadoPeer::IDSUCURSALEMPLEADO;
        if (null !== $this->idsucursalempleado) {
        ...
        if ($this->isColumnModified(SucursalempleadoPeer::IDSUCURSALEMPLEADO)) {
            $modifiedColumns[':p' . $index++]  = '`idsucursalempleado`';
        }
        if ($this->isColumnModified(SucursalempleadoPeer::IDSUCURSAL)) {
        ...
        $sql = sprintf(
            'INSERT INTO `sucursalempleado` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idsucursalempleado`':
                        $stmt->bindValue($identifier, $this->idsucursalempleado, PDO::PARAM_INT);
                        break;
                    case '`idsucursal`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SucursalempleadoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SucursalempleadoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdsucursalempleado();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Sucursalempleado'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Sucursalempleado'][$this->getPrimaryKey()] = true;
        $keys = SucursalempleadoPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdsucursalempleado($value);
                break;
            case 1:
    ...
    {
        $criteria = new Criteria(SucursalempleadoPeer::DATABASE_NAME);
        $criteria->add(SucursalempleadoPeer::IDSUCURSALEMPLEADO, $this->idsucursalempleado);
    ...
    /**
     * Generic method to set the primary key (idsucursalempleado column).
     *
    ...
    {
        $this->setIdsucursalempleado($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdsucursalempleado();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Sucursalempleado (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdsucursalempleado(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Sucursalempleado Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SucursalempleadoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SucursalempleadoPeer();
        }
    ...
    public function getEmpleado(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmpleado === null && ($this->idempleado !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpleado->addSucursalempleados($this);
             */
        }
    ...
    public function getSucursal(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSucursal === null && ($this->idsucursal !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSucursal->addSucursalempleados($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SucursalempleadoPeer::DEFAULT_STRING_FORMAT);
    }
