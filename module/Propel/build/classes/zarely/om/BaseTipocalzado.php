...
/**
 * Base class that represents a row from the 'tipocalzado' table.
 *
 *
 *
 * @package    propel.generator.zarely.om
 */
abstract class BaseTipocalzado extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TipocalzadoPeer';
    ...
    /**
     * The value for the tipocalzado_nombre field.
     * @var        string
     */
    ...
    /**
     * Get the [tipocalzado_nombre] column value.
     *
     * @return string
     */
    public function getTipocalzadoNombre()
    {

        return $this->tipocalzado_nombre;
    }
    ...
    public function setIdtipocalzado($v)
    {
        ...
        if ($this->idtipocalzado !== $v) {
            ...
            $this->modifiedColumns[] = TipocalzadoPeer::IDTIPOCALZADO;
        }
    ...
    /**
     * Set the value of [tipocalzado_nombre] column.
     *
     * @param  string $v new value
     * @return Tipocalzado The current object (for fluent API support)
     */
    public function setTipocalzadoNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->tipocalzado_nombre !== $v) {
            $this->tipocalzado_nombre = $v;
            $this->modifiedColumns[] = TipocalzadoPeer::TIPOCALZADO_NOMBRE;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TipocalzadoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TipocalzadoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TipocalzadoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TipocalzadoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TipocalzadoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Tipocalzado'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tipocalzado'][$this->getPrimaryKey()] = true;
        $keys = TipocalzadoPeer::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(TipocalzadoPeer::DATABASE_NAME);
        $criteria->add(TipocalzadoPeer::IDTIPOCALZADO, $this->idtipocalzado);
    ...
    /**
     * Generic method to set the primary key (idtipocalzado column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdtipocalzado();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Tipocalzado (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdtipocalzado(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Tipocalzado Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TipocalzadoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TipocalzadoPeer();
        }
     ...
     * If this Tipocalzado is new, it will return
    ...
    public function setProductos(PropelCollection $productos, PropelPDO $con = null)
    {
        ...
        foreach ($productosToDelete as $productoRemoved) {
            $productoRemoved->setTipocalzado(null);
        }
     ...
     * Otherwise if this Tipocalzado is new, it will return
     * an empty collection; or if this Tipocalzado has previously
     * been saved, it will retrieve related Productos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Tipocalzado.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Producto[] List of Producto objects
     */
    public function getProductosJoinTallaje($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProductoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TipocalzadoPeer::DEFAULT_STRING_FORMAT);
    }
