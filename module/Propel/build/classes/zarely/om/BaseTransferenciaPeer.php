...
abstract class BaseTransferenciaPeer
{
    ...
    const IDSUCURSALORIGEN = 'transferencia.idsucursalorigen';

    /** the column name for the idsucursaldestino field */
    const IDSUCURSALDESTINO = 'transferencia.idsucursaldestino';
    ...
    const IDEMPLEADOCREADOR = 'transferencia.idempleadocreador';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TransferenciaPeer::IDSUCURSALORIGEN);
            $criteria->addSelectColumn(TransferenciaPeer::IDSUCURSALDESTINO);
            ...
            $criteria->addSelectColumn(TransferenciaPeer::IDEMPLEADOCREADOR);
    ...
    public static function doCountJoinEmpleadoRelatedByIdempleadocreador(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TransferenciaPeer::IDEMPLEADOCREADOR, EmpleadoPeer::IDEMPLEADO, $join_behavior);
    ...
    public static function doCountJoinSucursalRelatedByIdsucursaldestino(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TransferenciaPeer::IDSUCURSALDESTINO, SucursalPeer::IDSUCURSAL, $join_behavior);
    ...
    public static function doCountJoinSucursalRelatedByIdsucursalorigen(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TransferenciaPeer::IDSUCURSALORIGEN, SucursalPeer::IDSUCURSAL, $join_behavior);
    ...
    public static function doSelectJoinEmpleadoRelatedByIdempleadocreador(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                $obj2->addTransferenciaRelatedByIdempleadocreador($obj1);
    ...
    /**
     * Selects a collection of Transferencia objects pre-filled with their Sucursal objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Transferencia objects.
    ...
    public static function doSelectJoinSucursalRelatedByIdsucursaldestino(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Transferencia) to $obj2 (Sucursal)
                $obj2->addTransferenciaRelatedByIdsucursaldestino($obj1);
    ...
    public static function doSelectJoinSucursalRelatedByIdsucursalorigen(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Transferencia) to $obj2 (Sucursal)
                $obj2->addTransferenciaRelatedByIdsucursalorigen($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (Transferencia) to the collection in $obj4 (Sucursal)
                $obj4->addTransferenciaRelatedByIdsucursaldestino($obj1);
            } // if joined row not null
            ...
            if ($key5 !== null) {
                ...
                // Add the $obj1 (Transferencia) to the collection in $obj5 (Sucursal)
                $obj5->addTransferenciaRelatedByIdsucursalorigen($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Transferencia objects pre-filled with all related objects except EmpleadoRelatedByIdempleadocreador.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptEmpleadoRelatedByIdempleadocreador(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = TransferenciaPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Transferencia) to the collection in $obj2 (Sucursal)
                $obj2->addTransferenciaRelatedByIdsucursaldestino($obj1);
                ...
                // Add the $obj1 (Transferencia) to the collection in $obj3 (Sucursal)
                $obj3->addTransferenciaRelatedByIdsucursalorigen($obj1);
    ...
    /**
     * Selects a collection of Transferencia objects pre-filled with all related objects except SucursalRelatedByIdsucursaldestino.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Transferencia objects pre-filled with all related objects except SucursalRelatedByIdsucursalorigen.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
