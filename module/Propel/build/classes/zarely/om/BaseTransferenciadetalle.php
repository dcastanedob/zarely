...
abstract class BaseTransferenciadetalle extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the transferenciadetalle_preciounitario field.
     * @var        string
     */
    protected $transferenciadetalle_preciounitario;

    /**
     * The value for the transferenciadetalle_subtotal field.
     * @var        string
     */
    protected $transferenciadetalle_subtotal;
    ...
    /**
     * Get the [transferenciadetalle_preciounitario] column value.
     *
     * @return string
     */
    public function getTransferenciadetallePreciounitario()
    {

        return $this->transferenciadetalle_preciounitario;
    }

    /**
     * Get the [transferenciadetalle_subtotal] column value.
     *
     * @return string
     */
    public function getTransferenciadetalleSubtotal()
    {

        return $this->transferenciadetalle_subtotal;
    }
    ...
    public function setIdproductovariante($v)
    {
        ...
        if ($this->idproductovariante !== $v) {
            ...
            $this->modifiedColumns[] = TransferenciadetallePeer::IDPRODUCTOVARIANTE;
        }
    ...
    /**
     * Set the value of [transferenciadetalle_preciounitario] column.
     *
     * @param  string $v new value
     * @return Transferenciadetalle The current object (for fluent API support)
     */
    public function setTransferenciadetallePreciounitario($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->transferenciadetalle_preciounitario !== $v) {
            $this->transferenciadetalle_preciounitario = $v;
            $this->modifiedColumns[] = TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO;
        }


        return $this;
    } // setTransferenciadetallePreciounitario()

    /**
     * Set the value of [transferenciadetalle_subtotal] column.
     *
     * @param  string $v new value
     * @return Transferenciadetalle The current object (for fluent API support)
     */
    public function setTransferenciadetalleSubtotal($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->transferenciadetalle_subtotal !== $v) {
            $this->transferenciadetalle_subtotal = $v;
            $this->modifiedColumns[] = TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL;
        }


        return $this;
    } // setTransferenciadetalleSubtotal()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->transferenciadetalle_cantidad = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->transferenciadetalle_preciounitario = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->transferenciadetalle_subtotal = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = TransferenciadetallePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TransferenciadetallePeer::IDPRODUCTOVARIANTE)) {
        ...
        if ($this->isColumnModified(TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO)) {
            $modifiedColumns[':p' . $index++]  = '`transferenciadetalle_preciounitario`';
        }
        if ($this->isColumnModified(TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL)) {
            $modifiedColumns[':p' . $index++]  = '`transferenciadetalle_subtotal`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`transferenciadetalle_cantidad`':
                        ...
                        break;
                    case '`transferenciadetalle_preciounitario`':
                        $stmt->bindValue($identifier, $this->transferenciadetalle_preciounitario, PDO::PARAM_STR);
                        break;
                    case '`transferenciadetalle_subtotal`':
                        $stmt->bindValue($identifier, $this->transferenciadetalle_subtotal, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                return $this->getTransferenciadetallePreciounitario();
                break;
            case 5:
                return $this->getTransferenciadetalleSubtotal();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getTransferenciadetalleCantidad(),
            $keys[4] => $this->getTransferenciadetallePreciounitario(),
            $keys[5] => $this->getTransferenciadetalleSubtotal(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 3:
                ...
                break;
            case 4:
                $this->setTransferenciadetallePreciounitario($value);
                break;
            case 5:
                $this->setTransferenciadetalleSubtotal($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setTransferenciadetalleCantidad($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setTransferenciadetallePreciounitario($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setTransferenciadetalleSubtotal($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TransferenciadetallePeer::IDPRODUCTOVARIANTE)) $criteria->add(TransferenciadetallePeer::IDPRODUCTOVARIANTE, $this->idproductovariante);
        ...
        if ($this->isColumnModified(TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO)) $criteria->add(TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO, $this->transferenciadetalle_preciounitario);
        if ($this->isColumnModified(TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL)) $criteria->add(TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL, $this->transferenciadetalle_subtotal);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTransferenciadetallePreciounitario($this->getTransferenciadetallePreciounitario());
        $copyObj->setTransferenciadetalleSubtotal($this->getTransferenciadetalleSubtotal());
    ...
    public function getProductovariante(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProductovariante === null && ($this->idproductovariante !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProductovariante->addTransferenciadetalles($this);
             */
        }
    ...
    public function clear()
    {
        ...
        $this->transferenciadetalle_preciounitario = null;
        $this->transferenciadetalle_subtotal = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
