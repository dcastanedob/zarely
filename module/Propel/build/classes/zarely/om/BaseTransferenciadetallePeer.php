...
abstract class BaseTransferenciadetallePeer
{
    ...
    const IDPRODUCTOVARIANTE = 'transferenciadetalle.idproductovariante';
    ...
    /** the column name for the transferenciadetalle_preciounitario field */
    const TRANSFERENCIADETALLE_PRECIOUNITARIO = 'transferenciadetalle.transferenciadetalle_preciounitario';

    /** the column name for the transferenciadetalle_subtotal field */
    const TRANSFERENCIADETALLE_SUBTOTAL = 'transferenciadetalle.transferenciadetalle_subtotal';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idtransferenciadetalle', 'Idtransferencia', 'Idproductovariante', 'TransferenciadetalleCantidad', 'TransferenciadetallePreciounitario', 'TransferenciadetalleSubtotal', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idtransferenciadetalle', 'idtransferencia', 'idproductovariante', 'transferenciadetalleCantidad', 'transferenciadetallePreciounitario', 'transferenciadetalleSubtotal', ),
        BasePeer::TYPE_COLNAME => array (TransferenciadetallePeer::IDTRANSFERENCIADETALLE, TransferenciadetallePeer::IDTRANSFERENCIA, TransferenciadetallePeer::IDPRODUCTOVARIANTE, TransferenciadetallePeer::TRANSFERENCIADETALLE_CANTIDAD, TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO, TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDTRANSFERENCIADETALLE', 'IDTRANSFERENCIA', 'IDPRODUCTOVARIANTE', 'TRANSFERENCIADETALLE_CANTIDAD', 'TRANSFERENCIADETALLE_PRECIOUNITARIO', 'TRANSFERENCIADETALLE_SUBTOTAL', ),
        BasePeer::TYPE_FIELDNAME => array ('idtransferenciadetalle', 'idtransferencia', 'idproductovariante', 'transferenciadetalle_cantidad', 'transferenciadetalle_preciounitario', 'transferenciadetalle_subtotal', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idtransferenciadetalle' => 0, 'Idtransferencia' => 1, 'Idproductovariante' => 2, 'TransferenciadetalleCantidad' => 3, 'TransferenciadetallePreciounitario' => 4, 'TransferenciadetalleSubtotal' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idtransferenciadetalle' => 0, 'idtransferencia' => 1, 'idproductovariante' => 2, 'transferenciadetalleCantidad' => 3, 'transferenciadetallePreciounitario' => 4, 'transferenciadetalleSubtotal' => 5, ),
        BasePeer::TYPE_COLNAME => array (TransferenciadetallePeer::IDTRANSFERENCIADETALLE => 0, TransferenciadetallePeer::IDTRANSFERENCIA => 1, TransferenciadetallePeer::IDPRODUCTOVARIANTE => 2, TransferenciadetallePeer::TRANSFERENCIADETALLE_CANTIDAD => 3, TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO => 4, TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDTRANSFERENCIADETALLE' => 0, 'IDTRANSFERENCIA' => 1, 'IDPRODUCTOVARIANTE' => 2, 'TRANSFERENCIADETALLE_CANTIDAD' => 3, 'TRANSFERENCIADETALLE_PRECIOUNITARIO' => 4, 'TRANSFERENCIADETALLE_SUBTOTAL' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('idtransferenciadetalle' => 0, 'idtransferencia' => 1, 'idproductovariante' => 2, 'transferenciadetalle_cantidad' => 3, 'transferenciadetalle_preciounitario' => 4, 'transferenciadetalle_subtotal' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TransferenciadetallePeer::IDPRODUCTOVARIANTE);
            $criteria->addSelectColumn(TransferenciadetallePeer::TRANSFERENCIADETALLE_CANTIDAD);
            $criteria->addSelectColumn(TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO);
            $criteria->addSelectColumn(TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.transferenciadetalle_preciounitario');
            $criteria->addSelectColumn($alias . '.transferenciadetalle_subtotal');
        }
    }
    ...
    public static function doCountJoinProductovariante(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TransferenciadetallePeer::IDPRODUCTOVARIANTE, ProductovariantePeer::IDPRODUCTOVARIANTE, $join_behavior);
    ...
    /**
     * Selects a collection of Transferenciadetalle objects pre-filled with their Productovariante objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinProductovariante(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Transferenciadetalle) to $obj2 (Productovariante)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Transferenciadetalle) to the collection in $obj2 (Productovariante)
                $obj2->addTransferenciadetalle($obj1);
    ...
    /**
     * Selects a collection of Transferenciadetalle objects pre-filled with all related objects except Productovariante.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptProductovariante(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = TransferenciadetallePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Transferenciadetalle) to the collection in $obj2 (Transferencia)
                $obj2->addTransferenciadetalle($obj1);
