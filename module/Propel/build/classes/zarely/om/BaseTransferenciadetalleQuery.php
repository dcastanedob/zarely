 ...
 * @method TransferenciadetalleQuery orderByIdproductovariante($order = Criteria::ASC) Order by the idproductovariante column
 ...
 * @method TransferenciadetalleQuery orderByTransferenciadetallePreciounitario($order = Criteria::ASC) Order by the transferenciadetalle_preciounitario column
 * @method TransferenciadetalleQuery orderByTransferenciadetalleSubtotal($order = Criteria::ASC) Order by the transferenciadetalle_subtotal column
 *
 ...
 * @method TransferenciadetalleQuery groupByIdproductovariante() Group by the idproductovariante column
 * @method TransferenciadetalleQuery groupByTransferenciadetalleCantidad() Group by the transferenciadetalle_cantidad column
 * @method TransferenciadetalleQuery groupByTransferenciadetallePreciounitario() Group by the transferenciadetalle_preciounitario column
 * @method TransferenciadetalleQuery groupByTransferenciadetalleSubtotal() Group by the transferenciadetalle_subtotal column
 *
 ...
 *
 * @method TransferenciadetalleQuery leftJoinProductovariante($relationAlias = null) Adds a LEFT JOIN clause to the query using the Productovariante relation
 * @method TransferenciadetalleQuery rightJoinProductovariante($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Productovariante relation
 * @method TransferenciadetalleQuery innerJoinProductovariante($relationAlias = null) Adds a INNER JOIN clause to the query using the Productovariante relation
 *
 ...
 * @method Transferenciadetalle findOneByIdproductovariante(int $idproductovariante) Return the first Transferenciadetalle filtered by the idproductovariante column
 ...
 * @method Transferenciadetalle findOneByTransferenciadetallePreciounitario(string $transferenciadetalle_preciounitario) Return the first Transferenciadetalle filtered by the transferenciadetalle_preciounitario column
 * @method Transferenciadetalle findOneByTransferenciadetalleSubtotal(string $transferenciadetalle_subtotal) Return the first Transferenciadetalle filtered by the transferenciadetalle_subtotal column
 *
 ...
 * @method array findByIdproductovariante(int $idproductovariante) Return Transferenciadetalle objects filtered by the idproductovariante column
 ...
 * @method array findByTransferenciadetallePreciounitario(string $transferenciadetalle_preciounitario) Return Transferenciadetalle objects filtered by the transferenciadetalle_preciounitario column
 * @method array findByTransferenciadetalleSubtotal(string $transferenciadetalle_subtotal) Return Transferenciadetalle objects filtered by the transferenciadetalle_subtotal column
 *
...
abstract class BaseTransferenciadetalleQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `idtransferenciadetalle`, `idtransferencia`, `idproductovariante`, `transferenciadetalle_cantidad`, `transferenciadetalle_preciounitario`, `transferenciadetalle_subtotal` FROM `transferenciadetalle` WHERE `idtransferenciadetalle` = :p0';
        try {
    ...
    public function filterByIdproductovariante($idproductovariante = null, $comparison = null)
    {
        if (is_array($idproductovariante)) {
            ...
            if (isset($idproductovariante['min'])) {
                $this->addUsingAlias(TransferenciadetallePeer::IDPRODUCTOVARIANTE, $idproductovariante['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idproductovariante['max'])) {
                $this->addUsingAlias(TransferenciadetallePeer::IDPRODUCTOVARIANTE, $idproductovariante['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TransferenciadetallePeer::IDPRODUCTOVARIANTE, $idproductovariante, $comparison);
    }
    ...
    /**
     * Filter the query on the transferenciadetalle_preciounitario column
     *
     * Example usage:
     * <code>
     * $query->filterByTransferenciadetallePreciounitario(1234); // WHERE transferenciadetalle_preciounitario = 1234
     * $query->filterByTransferenciadetallePreciounitario(array(12, 34)); // WHERE transferenciadetalle_preciounitario IN (12, 34)
     * $query->filterByTransferenciadetallePreciounitario(array('min' => 12)); // WHERE transferenciadetalle_preciounitario >= 12
     * $query->filterByTransferenciadetallePreciounitario(array('max' => 12)); // WHERE transferenciadetalle_preciounitario <= 12
     * </code>
     *
     * @param     mixed $transferenciadetallePreciounitario The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return TransferenciadetalleQuery The current query, for fluid interface
     */
    public function filterByTransferenciadetallePreciounitario($transferenciadetallePreciounitario = null, $comparison = null)
    {
        if (is_array($transferenciadetallePreciounitario)) {
            $useMinMax = false;
            if (isset($transferenciadetallePreciounitario['min'])) {
                $this->addUsingAlias(TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO, $transferenciadetallePreciounitario['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($transferenciadetallePreciounitario['max'])) {
                $this->addUsingAlias(TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO, $transferenciadetallePreciounitario['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TransferenciadetallePeer::TRANSFERENCIADETALLE_PRECIOUNITARIO, $transferenciadetallePreciounitario, $comparison);
    }

    /**
     * Filter the query on the transferenciadetalle_subtotal column
     *
     * Example usage:
     * <code>
     * $query->filterByTransferenciadetalleSubtotal(1234); // WHERE transferenciadetalle_subtotal = 1234
     * $query->filterByTransferenciadetalleSubtotal(array(12, 34)); // WHERE transferenciadetalle_subtotal IN (12, 34)
     * $query->filterByTransferenciadetalleSubtotal(array('min' => 12)); // WHERE transferenciadetalle_subtotal >= 12
     * $query->filterByTransferenciadetalleSubtotal(array('max' => 12)); // WHERE transferenciadetalle_subtotal <= 12
     * </code>
     *
     * @param     mixed $transferenciadetalleSubtotal The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return TransferenciadetalleQuery The current query, for fluid interface
     */
    public function filterByTransferenciadetalleSubtotal($transferenciadetalleSubtotal = null, $comparison = null)
    {
        if (is_array($transferenciadetalleSubtotal)) {
            $useMinMax = false;
            if (isset($transferenciadetalleSubtotal['min'])) {
                $this->addUsingAlias(TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL, $transferenciadetalleSubtotal['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($transferenciadetalleSubtotal['max'])) {
                $this->addUsingAlias(TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL, $transferenciadetalleSubtotal['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TransferenciadetallePeer::TRANSFERENCIADETALLE_SUBTOTAL, $transferenciadetalleSubtotal, $comparison);
    }
    ...
    public function filterByProductovariante($productovariante, $comparison = null)
    {
        if ($productovariante instanceof Productovariante) {
            return $this
                ->addUsingAlias(TransferenciadetallePeer::IDPRODUCTOVARIANTE, $productovariante->getIdproductovariante(), $comparison);
            ...
            return $this
                ->addUsingAlias(TransferenciadetallePeer::IDPRODUCTOVARIANTE, $productovariante->toKeyValue('PrimaryKey', 'Idproductovariante'), $comparison);
        } else {
