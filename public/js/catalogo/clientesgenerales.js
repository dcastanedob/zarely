    ...
    $.clientes = function(container, options){
        ...
        */
        ...
        plugin.initForm = function(){
            ...
            $.ajax({
                url:'/catalogo/clientesgenerales/getClientes',
                type: 'POST',
                dataType: 'JSON',
                data:{
                    name: 'clientes',
            ...
            $container.find('#btn_add_cliente').on('click',function(){
              ...
              clientes_text.forEach(function(value,index){
                ...
                if($.inArray(id,clientes_added) < 0)
                {
                  $.ajax({
                    method: 'POST',
                    url:'/catalogo/clientesgenerales/initializetable',
                    dataType:'JSON',
                    data:{
                      id:id,
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/catalogo/clientesgenerales/serverside',
                    },
                    columns:[
                                   ...
                                   ' <div class="modal-content animated bounceInLeft">',
                                    '  <div class="modal-header">',
                                       ' <button type="button" class="close" data-dismiss="modal">',
                                        ...
                                        '</button>',
                                      '</div>',
                                      '<form action="/catalogo/clientesgenerales/eliminar/'+id+'" method="POST">',
