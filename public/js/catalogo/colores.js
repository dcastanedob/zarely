(function( $ ){
    ...
    */
    ...
    $.fn.colores= function(data){
        var _this = $(this);
        var plugin = _this.data('colores');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.colores(this, data);
            
            _this.data('colores', plugin);
    ...
    */
    ...
    $.colores = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/catalogo/colores/serverside',
                    },
                    columns:[
                        {"data":"idcolor","name":"idcolor","orderable":true},
                        {"data":"color_nombre","name":"color_nombre","orderable":true},
                                   ...
                                   ' <div class="modal-content animated bounceInLeft">',
                                    '  <div class="modal-header">',
                                       ' <button type="button" class="close" data-dismiss="modal">',
                                        ...
                                        '</button>',
                                      '</div>',
                                      '<form action="/catalogo/colores/eliminar/'+id+'" method="POST">',
