(function( $ ){
    ...
    */
    ...
    $.fn.descuentos= function(data){
        var _this = $(this);
        var plugin = _this.data('descuentos');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.descuentos(this, data);
            
            _this.data('descuentos', plugin);
    ...
    */
    ...
    $.descuentos = function(container, options){
        ...
        */ 
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/catalogo/descuentos/serverside',
                    },
                    columns:[
                        {"data":"descuento_nombre","name":"descuento_nombre","orderable":true},
                        {"data":"descuento_tipo","name":"descuento_tipo","orderable":true},
                        {"data":"descuento_esatus","name":"descuento_esatus","orderable":true},
                        {"data":"descuento_fechainicio","name":"descuento_fechainicio","orderable":true},
                        {"data":"descuento_fechafin","name":"descuento_fechafin","orderable":true},
                        {"data":"descuento_cantidad","name":"descuento_cantidad","orderable":false},
                                   ...
                                   ' <div class="modal-content animated bounceInLeft">',
                                    '  <div class="modal-header">',
                                       ' <button type="button" class="close" data-dismiss="modal">',
                                        ...
                                        '</button>',
                                      '</div>',
                                      '<form action="/catalogo/descuentos/eliminar/'+id+'" method="POST">',
        ...
        plugin.initForm = function(){
            ...
            $.ajax({
                url:'/catalogo/descuentos/getProductos',
                type: 'POST',
                dataType: 'JSON',
                data:{
                    name: 'productos',
            ...
            $.ajax({
                url:'/catalogo/descuentos/getMarcas',
                type: 'POST',
                dataType: 'JSON',
                data:{
                    name: 'marcas',
            ...
            $.ajax({
                url:'/catalogo/descuentos/getVariantes',
                type: 'POST',
                dataType: 'JSON',
                data:{
                    name: 'variantes',
