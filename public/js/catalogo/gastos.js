            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    columns:[
                        {"data":"idgasto","name":"idgasto","orderable":true},
                        {"data":"gasto_nombre","name":"gasto_nombre","orderable":true},
                        {"data":"gasto_descripcion","name":"gasto_descripcion","orderable":true},
                                   ...
                                   ' <div class="modal-content animated bounceInLeft">',
                                    '  <div class="modal-header">',
                                       ' <button type="button" class="close" data-dismiss="modal">',
                                        ...
                                        '</button>',
                                      '</div>',
                                      '<form action="/catalogo/gastos/eliminar/'+id+'" method="POST">',
