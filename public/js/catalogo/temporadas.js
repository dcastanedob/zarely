(function( $ ){
    ...
    */
    ...
    $.fn.temporadas= function(data){
        var _this = $(this);
        var plugin = _this.data('temporadas');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.temporadas(this, data);
            
            _this.data('temporadas', plugin);
    ...
    */
    ...
    $.temporadas = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/catalogo/temporadas/serverside',
                    },
                    columns:[
                                   ...
                                   ' <div class="modal-content animated bounceInLeft">',
                                    '  <div class="modal-header">',
                                       ' <button type="button" class="close" data-dismiss="modal">',
                                        ...
                                        '</button>',
                                      '</div>',
                                      '<form action="/catalogo/temporadas/eliminar/'+id+'" method="POST">',
