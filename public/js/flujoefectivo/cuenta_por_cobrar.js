(function( $ ){
    ...
    */
    ...
    $.fn.cuenta_por_cobrar= function(data){
        var _this = $(this);
        var plugin = _this.data('cuenta_por_cobrar');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.cuenta_por_cobrar(this, data);
            
            _this.data('cuenta_por_cobrar', plugin);
    ...
    */
    ...
    $.cuenta_por_cobrar = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/flujo-efectivo/porcobrar/serverside',
                    },
                    columns:[
                                   ...
                                   ' <div class="modal-content animated bounceInLeft">',
                                    '  <div class="modal-header">',
                                       ' <button type="button" class="close" data-dismiss="modal">',
                                        ...
                                        '</button>',
                                      '</div>',
                                      '<form action="/flujo-efectivo/porcobrar/eliminar/'+id+'" method="POST">',
