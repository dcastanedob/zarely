(function( $ ){
    ...
    */
    ...
    $.fn.cuenta_por_pagar= function(data){
        var _this = $(this);
        var plugin = _this.data('cuenta_por_pagar');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.cuenta_por_pagar(this, data);
            
            _this.data('cuenta_por_pagar', plugin);
    ...
    */
    ...
    $.cuenta_por_pagar = function(container, options){
                                   ...
                                   ' <div class="modal-content animated bounceInLeft">',
                                    '  <div class="modal-header">',
                                       ' <button type="button" class="close" data-dismiss="modal">',
                                        ...
                                        '</button>',
                                      '</div>',
                                      '<form action="/flujo-efectivo/porpagar/eliminar/'+id+'" method="POST">',
