(function( $ ){
    ...
    */
    ...
    $.fn.completado= function(data){
        var _this = $(this);
        var plugin = _this.data('completado');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.completado(this, data);
            
            _this.data('completado', plugin);
    ...
    */
    ...
    $.completado = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/completados/serverside',
                    },
                    columns:[
