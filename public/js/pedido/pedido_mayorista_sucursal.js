(function( $ ){
    ...
    */
    ...
    $.fn.pedido_mayorista_sucursal= function(data){
        var _this = $(this);
        var plugin = _this.data('pedido_mayorista_sucursal');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pedido_mayorista_sucursal(this, data);
            
            _this.data('pedido_mayorista_sucursal', plugin);
    ...
    */
    ...
    $.pedido_mayorista_sucursal = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/mayoristas/serversidesucursal',
                    },
                    columns:[
                        ...
                        {"data":"pedidomayorista_fechaentrega","name":"pedidomayorista_fechaentrega","orderable":true},
