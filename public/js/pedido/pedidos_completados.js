(function( $ ){
    ...
    */
    ...
    $.fn.pedidos_completados= function(data){
        var _this = $(this);
        var plugin = _this.data('pedidos_completados');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pedidos_completados(this, data);
            
            _this.data('pedidos_completados', plugin);
    ...
    */
    ...
    $.pedidos_completados = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/completados/serversideproductovariante',
                        data:{
                    ...
                    createdRow: function(row,data,index){
                        $(row).find('a').on('click',function(){
                            var id = $(row).attr('id');
                            $.ajax({
                                url:'/pedidos/completados/getdetails',
                                method:'post',
                                dataType:'json',
                                data:{idpedido:id},
                                success:function(data){
                                    ...
                                    data.data.forEach(function(value,index){
                                        ...
                                        $tr.find('button').on('click',function(){
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                url:'/pedidos/completados/actualizarinformacion',
                                                dataType: 'json',
                                                data:{
