(function( $ ){
    ...
    */
    ...
    $.fn.pedidos_completados_producto= function(data){
        var _this = $(this);
        var plugin = _this.data('pedidos_completados_producto');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pedidos_completados_producto(this, data);
            
            _this.data('pedidos_completados_producto', plugin);
    ...
    */
    ...
    $.pedidos_completados_producto = function(container, options){
        ...
        */ 
        ...
        plugin.list =function(){
            ...
            $.ajax({
                url:'/pedidos/completados-producto/initializetable',
                type: 'POST',
                dataType: 'JSON',
                data:{
                    ...
                    $.each(data.data,function(index, value){
                      ...
                      $tr.find('a').filter(function(){
                        ...
                        $(this).on('click',function(){
                            ...
                            $.ajax({
                                url:'/pedidos/completados-producto/getdetails',
                                method:'post',
                                dataType:'json',
                            ...
                            $.ajax({
                                url:'/pedidos/mayoristas/getdetailcompletado',
                                method:'post',
                                dataType:'json',
                                data:{idvariante:idvariante},
                                success:function(data){
