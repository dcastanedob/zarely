(function( $ ){
    ...
    */
    ...
    $.fn.pedidos_pendientes_producto= function(data){
        var _this = $(this);
        var plugin = _this.data('pedidos_pendientes_producto');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pedidos_pendientes_producto(this, data);
            
            _this.data('pedidos_pendientes_producto', plugin);
    ...
    */
    ...
    $.pedidos_pendientes_producto = function(container, options){
        ...
        */ 
        ...
        plugin.list =function(){
            ...
            $.ajax({
                url:'/pedidos/pendientes-producto/initializetable',
                type: 'POST',
                dataType: 'JSON',
                data:{
                    ...
                    $.each(data.data,function(index, value){
                      ...
                      $tr.find('a').filter(function(){
                        ...
                        $(this).on('click',function(){
                            ...
                            $.ajax({
                                url:'/pedidos/transitos-producto/getdetails',
                                method:'post',
                                dataType:'json',
                            ...
                            $.ajax({
                                url:'/pedidos/mayoristas/getdetailpendiente',
                                method:'post',
                                dataType:'json',
                                data:{idvariante:idvariante},
                                success:function(data){
