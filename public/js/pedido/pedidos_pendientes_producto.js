            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/pendientes-producto/serversideproductovariante',
                        data:{
                    ...
                    createdRow: function(row,data,index){
                        $(row).find('a').on('click',function(){
                            var id = $(row).attr('id');
                            $.ajax({
                                url:'/pedidos/pendientes-producto/getdetails',
                                method:'post',
                                dataType:'json',
                                data:{idpedido:id},
                                success:function(data){
                                    ...
                                    data.data.forEach(function(value,index){
                                        ...
                                        $tr.find('button').on('click',function(){
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                url:'/pedidos/pendientes-producto/actualizarinformacion',
                                                dataType: 'json',
                                                data:{
