(function( $ ){
    ...
    */
    ...
    $.fn.pedidos_solicitados= function(data){
        var _this = $(this);
        var plugin = _this.data('pedidos_solicitados');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pedidos_solicitados(this, data);
            
            _this.data('pedidos_solicitados', plugin);
    ...
    */
    ...
    $.pedidos_solicitados = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/solicitados/serversideproductovariante',
                        data:{
                    ...
                    createdRow: function(row,data,index){
                        $(row).find('a').on('click',function(){
                            var id = $(row).attr('id');
                            $.ajax({
                                url:'/pedidos/solicitados/getdetails',
                                method:'post',
                                dataType:'json',
                                data:{idpedido:id},
                                success:function(data){
                                    ...
                                    data.data.forEach(function(value,index){
                                        ...
                                        $tr.find('button').on('click',function(){
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                url:'/pedidos/solicitados/actualizarinformacion',
                                                dataType: 'json',
                                                data:{
