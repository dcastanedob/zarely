(function( $ ){
    ...
    */
    ...
    $.fn.pedidos_solicitados_producto= function(data){
        var _this = $(this);
        var plugin = _this.data('pedidos_solicitados_producto');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pedidos_solicitados_producto(this, data);
            
            _this.data('pedidos_solicitados_producto', plugin);
    ...
    */
    ...
    $.pedidos_solicitados_producto = function(container, options){
        ...
        */ 
        ...
        plugin.list =function(){
            ...
            $.ajax({
                url:'/pedidos/solicitados-producto/initializetable',
                type: 'POST',
                dataType: 'JSON',
                data:{
                    ...
                    $.each(data.data,function(index, value){
                      ...
                      $tr.find('a').filter(function(){
                        ...
                        $(this).on('click',function(){
                            ...
                            $.ajax({
                                url:'/pedidos/solicitados-producto/getdetails',
                                method:'post',
                                dataType:'json',
                                ...
                                success:function(data){
                                    ...
                                    data.data.forEach(function(value,index){
                                        ...
                                        $tr.find('button').on('click',function(){
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                url:'/pedidos/transitos-producto/actualizarinformacion',
                                                dataType: 'json',
                                                data:{
                            ...
                            $.ajax({
                                url:'/pedidos/mayoristas/getdetailsolicitado',
                                method:'post',
                                dataType:'json',
                                data:{idvariante:idvariante},
                                success:function(data){
                                    ...
                                    data.data.forEach(function(value,index){
                                        ...
                                        $select.find('option[value='+value.pedidomayoristadetalle_estatus+']').attr('selected',true);

                                        console.log($select);
                                        $tr = $('<tr>');
                                        $tr.attr('id',value.idpedidomayoristadetalle);
                                        $tr.append('<td></td>');
                                        $tr.append('<td>'+value.idpedidomayorista+'</td>');
                                        $tr.append('<td>'+value.pedidomayoristadetalle_fecha+'</td>');
                                        $tr.append('<td><input name="pedido_cantidad" class="form-control" value="'+value.pedidomayoristadetalle_cantidad+'" disabled></td>');
                                        $tr.append('<td><select class="form-control">'+$select.html()+'</select></td>');
                                        $tr.append('<td><button class="btn btn-primary">Guardar</button></td>');
                                        ...
                                        $tr.find('button').on('click',function(){
                                            ...
                                            $.ajax({
                                                method: 'POST',
                                                url:'/pedidos/mayoristas/actualizarinformacion',
                                                dataType: 'json',
                                                data:{
                                                    idpedido:value.idpedidomayoristadetalle,
                                                    pedido_estatus:pedido_estatus,
                                                },
                                                success: function(data){
                                                    console.log(data);
