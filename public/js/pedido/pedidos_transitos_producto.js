(function( $ ){
    ...
    */
    ...
    $.fn.pedidos_transitos_producto= function(data){
        var _this = $(this);
        var plugin = _this.data('pedidos_transitos_producto');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pedidos_transitos_producto(this, data);
            
            _this.data('pedidos_transitos_producto', plugin);
    ...
    */
    ...
    $.pedidos_transitos_producto = function(container, options){
        ...
        */ 
        ...
        plugin.list =function(){
            ...
            $.ajax({
                url:'/pedidos/transitos-producto/initializetable',
                type: 'POST',
                dataType: 'JSON',
                data:{
                    ...
                    $.each(data.data,function(index, value){
                      ...
                      $tr.find('a').filter(function(){
                        ...
                        $(this).on('click',function(){
                            ...
                            $.ajax({
                                url:'/pedidos/mayoristas/getdetailtransito',
                                method:'post',
                                dataType:'json',
                                data:{idvariante:idvariante},
                                success:function(data){
