(function( $ ){
    ...
    */
    ...
    $.fn.pendiente= function(data){
        var _this = $(this);
        var plugin = _this.data('pendiente');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pendiente(this, data);
            
            _this.data('pendiente', plugin);
    ...
    */
    ...
    $.pendiente = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/pendientes/serverside',
                    },
                    columns:[
