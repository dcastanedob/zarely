(function( $ ){
    ...
    */
    ...
    $.fn.pendiente_producto= function(data){
        var _this = $(this);
        var plugin = _this.data('pendiente_producto');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pendiente_producto(this, data);
            
            _this.data('pendiente_producto', plugin);
    ...
    */
    ...
    $.pendiente_producto = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/pendientes-producto/serverside',
                    },
                    columns:[
