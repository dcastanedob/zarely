(function( $ ){
    ...
    */
    ...
    $.fn.solicitado= function(data){
        var _this = $(this);
        var plugin = _this.data('solicitado');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.solicitado(this, data);
            
            _this.data('solicitado', plugin);
    ...
    */
    ...
    $.solicitado = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/solicitados/serverside',
                    },
                    columns:[
