(function( $ ){
    ...
    */
    ...
    $.fn.solicitado_producto= function(data){
        var _this = $(this);
        var plugin = _this.data('solicitado_producto');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.solicitado_producto(this, data);
            
            _this.data('solicitado_producto', plugin);
    ...
    */
    ...
    $.solicitado_producto = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/solicitados-producto/serverside',
                    },
                    columns:[
