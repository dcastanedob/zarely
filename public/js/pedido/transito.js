(function( $ ){
    ...
    */
    ...
    $.fn.transito= function(data){
        var _this = $(this);
        var plugin = _this.data('transito');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.transito(this, data);
            
            _this.data('transito', plugin);
    ...
    */
    ...
    $.transito = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/transitos/serverside',
                    },
                    columns:[
