(function( $ ){
    ...
    */
    ...
    $.fn.transito_producto= function(data){
        var _this = $(this);
        var plugin = _this.data('transito_producto');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.transito_producto(this, data);
            
            _this.data('transito_producto', plugin);
    ...
    */
    ...
    $.transito_producto = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/pedidos/transitos-producto/serverside',
                    },
                    columns:[
