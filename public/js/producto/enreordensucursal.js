(function( $ ){
    ...
    */
    ...
    $.fn.enreordensucursal= function(data){
        var _this = $(this);
        var plugin = _this.data('enreordensucursal');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.enreordensucursal(this, data);
            
            _this.data('enreordensucursal', plugin);
    ...
    */
    ...
    $.enreordensucursal = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/producto/enreorden/serversidesucursal',
                    },
                    columns:[
