(function( $ ){
    ...
    */
    ...
    $.fn.existencias_individuales= function(data){
        var _this = $(this);
        var plugin = _this.data('existencias_individuales');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.existencias_individuales(this, data);
            
            _this.data('existencias_individuales', plugin);
    ...
    */
    ...
    $.existencias_individuales = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/producto/existencias/serversideproductovariante',
                        data:{
