(function( $ ){
    ...
    */
    ...
    $.fn.productos_enreorden= function(data){
        var _this = $(this);
        var plugin = _this.data('productos_enreorden');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.productos_enreorden(this, data);
            
            _this.data('productos_enreorden', plugin);
    ...
    */
    ...
    $.productos_enreorden = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/producto/enreorden/serversideproductovariante',
                        data:{
