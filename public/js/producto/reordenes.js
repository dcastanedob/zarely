(function( $ ){
    ...
    */
    ...
    $.fn.reordenes= function(data){
        var _this = $(this);
        var plugin = _this.data('reordenes');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.reordenes(this, data);
            
            _this.data('reordenes', plugin);
    ...
    */
    ...
    $.reordenes = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/producto/reordenes/serverside',
                    },
                    columns:columns,
                    proccesing: true,
