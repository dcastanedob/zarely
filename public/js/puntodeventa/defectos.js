(function( $ ){
    ...
    */
    ...
    $.fn.defectos= function(data){
        var _this = $(this);
        var plugin = _this.data('defectos');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.defectos(this, data);
            
            _this.data('defectos', plugin);
    ...
    */
    ...
    $.defectos = function(container, options){
              ...
              $.ajax({
                    ...
                    data:{
                      ...
                      if($container.find('#diferencia_venta').val().split("$")[1] > 0 && data.response) 
                      {
                        ...
                        $.post('/puntodeventa/actualizardetallesdefecto', data).done(function(e){
                        });
