(function( $ ){
    ...
    */
    ...
    $.fn.puntodeventa= function(data){
        var _this = $(this);
        var plugin = _this.data('puntodeventa');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.puntodeventa(this, data);
            
            _this.data('puntodeventa', plugin);
    ...
    */
    ...
    $.puntodeventa = function(container, options){
                                   ...
                                   ' <div class="modal-content animated bounceInLeft">',
                                    '  <div class="modal-header">',
                                       ' <button type="button" class="close" data-dismiss="modal">',
                                        ...
                                        '</button>',
                                      '</div>',
                                      '<form action="/puntodeventa/eliminar/'+id+'" method="POST">',
