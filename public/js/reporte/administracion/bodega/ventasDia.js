(function( $ ){
    ...
    */
    ...
    $.fn.ventasDia= function(data){
        var _this = $(this);
        var plugin = _this.data('ventasDia');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.ventasDia(this, data);
            
            _this.data('ventasDia', plugin);
    ...
    */
    ...
    $.ventasDia = function(container, options){
