(function( $ ){
    ...
    */
    ...
    $.fn.ventasSucursal= function(data){
        var _this = $(this);
        var plugin = _this.data('ventasSucursal');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.ventasSucursal(this, data);
            
            _this.data('ventasSucursal', plugin);
    ...
    */
    ...
    $.ventasSucursal = function(container, options){
