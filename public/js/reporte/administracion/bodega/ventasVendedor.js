(function( $ ){
    ...
    */
    ...
    $.fn.ventasVendedor= function(data){
        var _this = $(this);
        var plugin = _this.data('ventasVendedor');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.ventasVendedor(this, data);
            
            _this.data('ventasVendedor', plugin);
    ...
    */
    ...
    $.ventasVendedor = function(container, options){
