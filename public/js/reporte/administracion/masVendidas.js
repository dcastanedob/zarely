(function( $ ){
    ...
    */
    ...
    $.fn.masVendidas= function(data){
        var _this = $(this);
        var plugin = _this.data('masVendidas');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.masVendidas(this, data);
            
            _this.data('masVendidas', plugin);
    ...
    */
    ...
    $.masVendidas = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    createdRow: function( nRow, aData, iDataIndex) {
                        ...
                        if(typeof aData.base64 != 'undefined'){
                            download("data:application/xls;base64,"+aData.base64,"masVendidas.XLS", "application/xls");
                        }
                    }
