(function( $ ){
    ...
    */
    ...
    $.fn.masVendidosSucursal= function(data){
        var _this = $(this);
        var plugin = _this.data('masVendidosSucursal');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.masVendidosSucursal(this, data);
            
            _this.data('masVendidosSucursal', plugin);
    ...
    */
    ...
    $.masVendidosSucursal = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    createdRow: function( nRow, aData, iDataIndex) {
                        ...
                        if(typeof aData.base64 != 'undefined'){
                            download("data:application/xls;base64,"+aData.base64,"masVendidosSucursal.XLS", "application/xls");
                        }
                    }
