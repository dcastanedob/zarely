(function( $ ){
    ...
    */
    ...
    $.fn.pagadas_clientes= function(data){
        var _this = $(this);
        var plugin = _this.data('pagadas_clientes');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.pagadas_clientes(this, data);
            
            _this.data('pagadas_clientes', plugin);
    ...
    */
    ...
    $.pagadas_clientes = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    columns:[
                        ...
                        {"data":"idventa","name":"idventa","orderable":true},
                    ...
                    createdRow: function( nRow, aData, iDataIndex) {
                        ...
                        if(typeof aData.base64 != 'undefined'){
                            download("data:application/xls;base64,"+aData.base64,"pagadas_clientes.XLS", "application/xls");
                        }
                    }
