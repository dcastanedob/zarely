(function( $ ){
    ...
    */
    ...
    $.fn.mascreditos= function(data){
        var _this = $(this);
        var plugin = _this.data('mascreditos');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.mascreditos(this, data);
            
            _this.data('mascreditos', plugin);
    ...
    */
    ...
    $.mascreditos = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    createdRow: function( nRow, aData, iDataIndex) {
                        ...
                        if(typeof aData.base64 != 'undefined'){
                            download("data:application/xls;base64,"+aData.base64,"mascreditos.XLS", "application/xls");
                        }
                    }
