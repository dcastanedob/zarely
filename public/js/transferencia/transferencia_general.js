(function( $ ){
    ...
    */
    ...
    $.fn.transferencia_general= function(data){
        var _this = $(this);
        var plugin = _this.data('transferencia_general');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.transferencia_general(this, data);
            
            _this.data('transferencia_general', plugin);
    ...
    */
    ...
    $.transferencia_general = function(container, options){
