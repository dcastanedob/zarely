(function( $ ){
    ...
    */
    ...
    $.fn.transferencia_generalsucursal= function(data){
        var _this = $(this);
        var plugin = _this.data('transferencia_generalsucursal');
        
        /*Inicializado ?*/
        if (!plugin) {
            
            plugin = new $.transferencia_generalsucursal(this, data);
            
            _this.data('transferencia_generalsucursal', plugin);
    ...
    */
    ...
    $.transferencia_generalsucursal = function(container, options){
            ...
            var $table = $container.find('.dataTable').dataTable(
                {
                    ...
                    ajax:{
                        method: 'POST',
                        url:'/transferencias/serversidesucursal',
                    },
                    columns:[
                                   ...
                                   ' <div class="modal-content animated bounceInLeft">',
                                    '  <div class="modal-header">',
                                       ' <button type="button" class="close" data-dismiss="modal">',
                                        ...
                                        '</button>',
                                      '</div>',
                                      '<form action="/transferencias/eliminar/'+id+'" method="POST">',
